...
const Navbar = () => {
  ...
  return (
    <nav className={`sm:px-20 px-10 sticky top-0 left-0 right-0 z-50 bg-[#EBEAFF] shadow-lg transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-[105%]'}`}>
